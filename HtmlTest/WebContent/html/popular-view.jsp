	...
	<section>
		<div class="popular_view">
			...
			<div id="area_container">
				<ul class="menu">
					<li><a class="seoul cl2 menu-link" data-menu="1">서울</a></li>
					<li><a class="incheon cl menu-link" data-menu="2">인천</a></li>
					<li><a>대전</a></li>
					<li><a>대구</a></li>
					<li><a>광주</a></li>
					<li><a>부산</a></li>
				...
				<div class="attraction_view">
					...
					<div class="out">
                        ...
                        <p>자세히 보기+</p>
										...
										id="content">한강 유람선은 1986년 10월
										26일, 서울특별시의 중심부를 동서로 가로지르는 유람선을 첫 취항하여 운항을 개시하였다.현재 ㈜이랜드크루즈에서
										여의도, 잠실을 중심으로 2개의 터미널을 운영하고 있다. </span>
								</div>
								<div class="attr_container">
							...
							<div class="slides_stay">
								<div class="stay_container">
									<span class="img"> <img
										src="images/seoul/나인트리 프리미어 호텔 인사동.jpg" />
											...
											프리미어 호텔 인사동</b></span> <span id="content">나인트리
										프리미어 호텔 인사동은 3호선 안국역 6번출구에서 걸어서 약 2분, 1호선 종각역 3-1번 출구에서 도보 약
										10분 거리에 있습니다. 경복궁, 광화문 등 한국의 대표 관광지까지 걸어서 약 15분이면 갈 수 있습니다. </span>
								</div>
								<div class="stay_container">
								...
								<div class="stay_container">
									<span class="img"> <img
										...
										id="content">글래드 강남 코엑스센터는 지하철
										2호선 삼성역 1번 출구에서 도보 1분 거리에 위치해 있습니다. 주변 관광지로는 쇼핑하기 좋은 코엑스몰이 도보
										약 5분, 롯데월드가 차로 약 10분, 신사동 가로수길이 차로 약 20분 정도 소요됩니다.호텔에서는 편리하게
										업무를 볼 수 있는 비즈니스 라운지와 피트니스 센터는 물론, 와인스토어와 세탁실까지 이용하실 수 있습니다. </span>
								</div>
								<div class="stay_container">
								...
								<div class="stay_container">
									<span class="img"> <img
										src="images/seoul/페어필드 바이 메리어트 서울.jpg" />
											...
											바이 메리어트 서울</b></span> <span id="content">페어필드
										바이 메리어트는 1호선 영등포역 3번 출구에서 도보 약 5분 거리에 있으며, 여의도 한강공원까지 차로 약
										10분, 영등포 타임스퀘어까지 도보 5분, 문래창작촌까지 도보로 약 20분 거리에 위치해 있습니다.</span>
								</div>
							</div>
						</div>
