...
<form method="POST" class="w3-container">
	...
	<div>
		...
		<input name="lprice" class="w3-input" placeholder="최저가" type="number" value="${SHOPPING.lprice}">
		<input name="hprice" class="w3-input" placeholder="최고가" type="number" value="${SHOPPING.hprice}">
	</div>
	<div>
