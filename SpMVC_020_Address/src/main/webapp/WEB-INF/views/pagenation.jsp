...
<div class="page-box">
	<ul class="page-body">
		...
		<c:if test="${PAGE.startPageNo > 1}">
			<li class="page-item">
				<a href="${rootPath}?pageno=1" class="page-link">1</a>
			</li>

			<li class="page-item">
				<a href="${rootPath}?pageno=${PAGE.currentPageNo - 1}" class="page-link">&lt;</a>
			</li>
		...
		<c:if test="${PAGE.endPageNo != PAGE.finalPageNo}">
			<li class="page-item">
				<a href="${rootPath}?pageno=${PAGE.finalPageNo}" class="page-link">${PAGE.finalPageNo}</a>
			</li>
