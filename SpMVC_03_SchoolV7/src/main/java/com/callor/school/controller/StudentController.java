...
public class StudentController {
	 ...
	 * 코드 시작 부분에서 httpSession의 getAttribute("변수명")를
	 * 사용하여 로그인 된 정보를 추출한다
	 ...
	 * @ResponseBody
	 * 
	 * Controller method에서 문자열을 return하면
	 * 문자열을 web client에게 그대로 전송하는 역할을 하도록 지시하는 Annotation이다
	 * 
	 * pom.xml에 jackson-bind Dependency를 추가하면
	 * List, 객체(VO) 등등의 데이터를 json type으로 변환하여 web client으로 전송한다
	 */
	...
	public StudentVO getStudent(@PathVariable String st_num) {
