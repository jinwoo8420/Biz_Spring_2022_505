...
public class UserController {
	...
	public String join(@Valid UserVO userVO, BindingResult result) {
		...
		// 인증 메일을 보내고 난 후 userVO의 key_ok 변수에는 인증 키가 담겨있는 상태가 된다
	 ...
	 * 데이터가 있으면 그대로 통과를 하고
	 * 만약 데이터가 없으면 SessiongAttribute에 보관중인 userVO 데이터를 가져와서
	 * 매개변수 userVO에 세팅한다
	 */
	...
	public String join_next(@Valid @ModelAttribute("userVO") UserVO userVO, BindingResult result, Model model,
...
//		return null;
	 ...
	 * 자동으로 객체를 생성하여 return하는 코드가 실행된다
	 */
