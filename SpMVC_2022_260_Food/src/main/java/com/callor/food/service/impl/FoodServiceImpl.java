...
public class FoodServiceImpl implements FoodService {
	...
	public List<FoodItem> getFoodItems(String queryString) throws URISyntaxException {
		...
		// API에 JSON 타입으로 데이터를 요청하기 위한 Header 생성
		...
		// String 타입으로 데이터를 수신하여 어떤 형태로 데이터가 수신되는지 확인하는 절차
		...
		// RestTemplate가 수신한 데이터를 중간에 가로채서 조작하기
		...
		log.debug("수신 데이터 {}", resFoodObject.getBody().getFoodKr.item);
